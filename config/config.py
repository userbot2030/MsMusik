...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002049500040"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/kansya-nt/MsMusik",
)
...
)  # Example:- https://t.me/Asupan_viral18plus
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/Berlinmusic_support
