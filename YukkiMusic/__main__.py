...
async def init():
    ...
    LOGGER("RadioGreatFM").info("RadioGreatFM Music Bot Started Successfully")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("RadioGreatFM").info("Stopping RadioGreatFM ! GoodBye")
